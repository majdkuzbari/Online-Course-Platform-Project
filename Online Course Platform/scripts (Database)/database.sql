...
('Digital Marketing Mastery', 'Learn comprehensive digital marketing strategies including SEO, social media, and email marketing.', 89.99, 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTR8fGRpZ2l0YWwlMjBtYXJrZXRpbmd8ZW58MHx8MHx8&auto=format&fit=crop&w=800&q=60', 3, 2, 'intermediate', '10 weeks'),
('Machine Learning Engineering', 'Deep dive into machine learning algorithms, neural networks, and AI applications.', 129.99, 'https://images.unsplash.com/photo-1555949963-aa79dcee981c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8YXJ0aWZpY2lhbCUyMGludGVsbGlnZW5jZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60', 2, 2, 'advanced', '14 weeks'),
('Mobile App Development', 'Build iOS and Android apps using React Native. Create cross-platform mobile applications.', 109.99, 'https://images.unsplash.com/photo-1512941937669-90a1b58e7e9c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTB8fG1vYmlsZSUyMGFwcHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=800&q=60', 1, 2, 'intermediate', '12 weeks');
